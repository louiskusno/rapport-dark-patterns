...
Auditer ces pratiques à grande échelle représente un défi technique et méthodologique considérable. Les approches traditionnelles d'audit algorithmique reposent sur des robots d'exploration (des bots) qui simulent le comportement d'utilisateurs en parcourant systématiquement les plateformes Web. Cette méthode présente toutefois trois limitations fondamentales :
